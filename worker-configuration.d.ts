/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1ec522addffd6b15b7bc5d13698cf8f3)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	PUBLIC_SITE_NAME: "JLB";
	CONTACT_TO_EMAIL: "REPLACE_WITH_DESTINATION_EMAIL";
	MAIL_FROM_EMAIL: "noreply@REPLACE_WITH_DOMAIN";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE_NAME" | "CONTACT_TO_EMAIL" | "MAIL_FROM_EMAIL">> {}
}
